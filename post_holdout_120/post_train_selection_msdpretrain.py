...
for i in range(200):
    ...
    with torch.no_grad():
        ...
        if scores_top > 0.97 and scores_top < 0.99:
            # print('accept')
...
Seg_model.load_state_dict(torch.load('/home/xiangcen/xiaoyao/prostate_training/train_seg_results/seg_model_only_pretrain_msd.ptm', map_location=device))
Seg_model.to(device)
